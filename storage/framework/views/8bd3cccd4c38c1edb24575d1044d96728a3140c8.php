...
<body>
            ...
            <div class="container">
                ...
                <a href="#" class="linkedin"><i class="bx bxl-linkedin"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Related links</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <a href="https://www.nabard.org/content.aspx?id=76"
                                    target="_blank">NABARD</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="https://nagafarmer.nagaland.gov.in/node/38"
                                    target="_blank">Agriculture Department</a></li>
    ...
    <?php if(Session::has('Grievance added')): ?>
        <script type="text/javascript">
            $(document).ready(function() {
                new PNotify({
                    title: 'Success',
                    text: 'Grievance added successfully',
                    type: 'success',
                    shadow: true,
                    delay: 3000,
                });
