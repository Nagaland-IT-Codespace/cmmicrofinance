          ...
          <form class="" action="<?php echo e(route('applicationForm.store')); ?>" method="post">
            ...
            <div class="row pt-2">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="project_duration" name="project_duration" maxlength="2" required>
              </div>

              <div class="form-group col-md-4">
                <label for="project_outlay">Project Outlay (in INR)</label>
                <input type="text" class="form-control" id="project_outlay" name="project_outlay" required>
              </div>
            </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mozhui/Personal/playground/cmmicrofinance/resources/views/applicationForms/add.blade.php ENDPATH**/ ?>